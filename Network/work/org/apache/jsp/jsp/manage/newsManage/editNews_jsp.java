...
public final class editNews_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t</script>\r\n");
      out.write("<!-- /TinyMCE -->\r\n");
      out.write("<title>网工后台管理－修改新闻</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if (!isLog) {
      ...
      out.write("            <div id=\"contentHeader\">&nbsp;&nbsp;<a href=\"/jsp/manage/\" class=\"normalLink\">后台管理</a> &nbsp;&gt;&nbsp;<a href=\"/jsp/manage/newsManage/news.jsp?page=1\" class=\"normalLink\">新闻管理</a> &nbsp;&gt;&nbsp;修改新闻&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"/images/Return.png\" width=\"12\" height=\"12\" /><a\r\n");
      out.write("                href=\"");
      out.print(parentURL);
      ...
      out.write("                  <input id=\"newsTitle\" name=\"newsTitle\" type=\"text\" style=\"width:480px; height:16px;\" value=\"");
      out.print(title);
      out.write("\"/>\r\n");
      out.write("              </div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("                <textarea id=\"newsContent\" name=\"newsContent\" style=\"width: 100%; height:310px;\">");
      ...
      out.write("                &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("                <input type=\"button\" name=\"saveFile\" value=\"上传\" onclick=\"return checkFileUpload('/jsp/manage/newsManage/saveNewsFile.jsp?isModify=1&id=");
      out.print(id );
      out.write("&parent=");
      out.print(parentURL);
      out.write("')\" /> \r\n");
      out.write("        \t</div>\r\n");
      out.write("                <div id=\"articleBottom\">\r\n");
      out.write("                    <input type=\"button\" name=\"modify\" value=\"确认修改\" onclick=\"return checkArticle('/jsp/manage/newsManage/saveNews.jsp?isModify=1&id=");
      out.print(id );
      out.write("&parent=");
      out.print(parentURL);
      out.write("')\" />\r\n");
