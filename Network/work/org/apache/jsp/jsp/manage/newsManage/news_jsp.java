...
public final class news_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>网工后台管理－新闻管理</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if (!isLog) {
      ...
      out.write("            <div id=\"contentHeader\"><div style=\"float:left;\">&nbsp;&nbsp;所有新闻：</div>\r\n");
      out.write("                ");
if(User.checkHaveAuthority(auth,User.publishNews)){ 
	...
	String currentURL = "http://"+request.getServerName()+":"+request.getServerPort()+request.getRequestURI()+"?"+request.getQueryString();
      ...
      out.write("                    <td height=\"30px\" align=\"left\" colspan=\"2\" style=\"border-bottom: dashed 1px #AAA;\"><img src=\"/images/news.png\" width=\"12\" height=\"12\" /><a href=\"/jsp/manage/newsManage/showNews.jsp?id=");
      out.print(n.getId());
      out.write("&parent=");
      ...
      out.print(aTitle);
      out.write("</a>");
if(User.checkHaveAuthority(auth,User.editNews)||curUser.equals(creater)){ 
...
};if(User.checkHaveAuthority(auth,User.delNews)||curUser.equals(creater)){ 
