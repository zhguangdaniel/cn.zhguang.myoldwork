...
public final class showInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>网工后台管理－通知内容</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if (!isLog) {
      ...
      out.write("            <div id=\"contentHeader\"><div style=\"float:left;\">&nbsp;&nbsp;<a href=\"/jsp/manage/\" class=\"normalLink\">后台管理</a> &nbsp;&gt;&nbsp;<a href=\"/jsp/manage/infoManage/info.jsp?page=1\" class=\"normalLink\">通知管理</a> &nbsp;&gt;&nbsp;通知内容&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"/images/download.png\" width=\"12\" height=\"9\" />");
if(User.checkHaveAuthority(auth,User.editInfo)||curUser.equals(info.getCreater())){ 
...
};if(User.checkHaveAuthority(auth,User.delInfo)||curUser.equals(info.getCreater())){ 
...
if(!(info.getCreater()==null)&&!info.getCreater().equals("")){
      out.write("\r\n");
      out.write("                            发布者：");
	...
	if (info.getModifyTime() != null) {
      ...
      out.print(info.getModifyTime().substring(0, 16));
      out.write("&nbsp;被");
