...
public final class publishInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t</script>\r\n");
      out.write("<!-- /TinyMCE -->\r\n");
      out.write("<title>网工后台管理－通知发布</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	if (!isLog) {
	...
	}else if(!User.checkHaveAuthority(((String)session.getAttribute("userAuthority")),User.publishInfo)){
      ...
      out.write("      <div id=\"contentHeader\">&nbsp;&nbsp;<a href=\"/jsp/manage/\" class=\"normalLink\">后台管理</a> &nbsp;&gt;&nbsp;<a href=\"/jsp/manage/infoManage/info.jsp?page=1\" class=\"normalLink\">通知管理</a> &nbsp;&gt;&nbsp;通知发布 </div>\r\n");
      out.write("      <form name=\"form_article\" method=\"post\" style=\"margin:0 auto;margin-left:10px; margin-right:10px;\">\r\n");
      out.write("        <div id=\"titleFrame\">标题：\r\n");
      out.write("          <input id=\"infoTitle\" name=\"infoTitle\" type=\"text\" value=\"");
      out.print(title);
      out.write("\" style=\"width:480px; height:16px;\"/>\r\n");
      out.write("        </div>\r\n");
      out.write("        <textarea id=\"infoContent\" name=\"infoContent\" style=\"width: 100%; height:330px;\">");
      ...
      out.write("          &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("          <input type=\"button\" name=\"saveFile\" value=\"上传\" onclick=\"return checkFileUpload('/jsp/manage/infoManage/saveInfoFile.jsp?isModify=0')\" />\r\n");
      out.write("        </div>\r\n");
      out.write("        <div id=\"articleBottom\">\r\n");
      out.write("          <input type=\"button\" name=\"publish\" value=\"发布\" onclick=\"return checkArticle('/jsp/manage/infoManage/saveInfo.jsp?isModify=0')\" />\r\n");
	...
	session.setAttribute("infoContent",new String(""));
