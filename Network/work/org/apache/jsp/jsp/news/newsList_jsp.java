...
pageCtrl=newsBean.getPage(curPage,20);
      ...
      out.write("      <div class=\"breadcrumbs\"> <a href=\"/\">首页</a> &nbsp;&gt;&nbsp;新闻中心 </div>\r\n");
      ...
      out.write("          <td width=\"60%\" height=\"30px\" align=\"left\"><a href=\"/jsp/news/news.jsp?id=");
      out.print(aNews.getId());
      out.write("\" target=\"_blank\" class=\"text\">");
      out.print(title);
      out.write("</a></td>\r\n");
      out.write("          <td width=\"20%\"><span class=\"dateText\">[");
      out.print(time);
      out.write("]</span></td>\r\n");
