...
public final class infoContent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<a href=\"/\">首页</a>&nbsp;&gt;&nbsp;<a href=\"/jsp/info/infoList.jsp?page=1\">通知信息</a> &nbsp;&gt;&nbsp;通知\r\n");
      out.write("</div>\r\n");
...
Info i = infoBean.getInfo(Integer.parseInt(request.getParameter("id")));
      ...
      out.write("    </tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("        <td align=\"center\" height=\"20px\" valign=\"bottom\" class=\"articleInfo\">\r\n");
      out.write("        ");

		if (!i.getCreater().equals("") && !(i.getCreater() == null)) {
		
      out.write("发布者：");
      out.print(i.getCreater());
      out.write("&nbsp;&nbsp;&nbsp;");
      ...
      out.write("\r\n");
      out.write("\t\t发布于：");
      out.print(i.getCreateTime().substring(0, 16));
      out.write("\r\n");
      out.write("        </td>\r\n");
      out.write("    </tr>\r\n");
      out.write("    <tr>\r\n");
	...
	if (i.getModifyTime() != null) {
      ...
      out.print(i.getModifyTime().substring(0, 16));
      out.write("&nbsp;被");
