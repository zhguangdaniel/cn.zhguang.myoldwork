...
<link href="/old_1/css/news.css" rel="stylesheet" type="text/css" />
...
<div id="container">
    ...
    <!--主信息区-->
    <div id="mainContent">
        <div id="breadcrumbs"> <a href="/old_1/index.jsp" class="normalLink">首页</a> &gt;新闻列表 </div>
        ...
        %>
            <tr>
                ...
                <td width="55%" height="30px" align="left"><img src="/old_1/images/news.png" width="12" height="12" /><a href="/old_1/jsp/news/news.jsp?id=<%=aNews.getId()%>" target="_blank" class="text" title=<%=title%>><%=aTitle%></a></td>
                <td width="15%"><span id="newsDate">[<%=aNews.getCreateTime().substring(0,10)%>]</span></td>
                <td width="15%"></td>
            </tr>
            <%}%>
