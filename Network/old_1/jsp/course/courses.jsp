...
<link href="/old_1/css/course.css" rel="stylesheet" type="text/css" />
</head>
<body>
<!--主体容器container-->
<div id="container">
    ...
    <!--主信息区-->
    <div id="mainContent">
        <div id="breadcrumbs"> <a href="/old_1/index.jsp" class="normalLink">首页</a>&nbsp;&gt;&nbsp;课程学习 </div>
        <div id="course">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td width="49%" id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;自然科学基础课程</td>
                    <td width="2%" rowspan="6">&nbsp;</td>
                    <td  width="49%" id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;IT平台基础课程</td>
                </tr>
                <tr>
                    <td valign="top"><ul>
                            <li><a href="#">数学分析</a></li>
                ...
                <tr>
                    <td id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;专业基础课程</td>
                    <td id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;专业技术课程</td>
                </tr>
                <tr>
                    <td valign="top"><ul>
                ...
                <tr>
                    <td id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;选修课</td>
                    <td id="tdTitle"><img src="/old_1/images/tdTitle.png" width="15" height="15" />&nbsp;实践课程</td>
                </tr>
                <tr>
                    <td valign="top"><ul>
