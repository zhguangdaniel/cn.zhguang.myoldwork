...
<%
	...
	}else if(!User.checkHaveAuthority(((String)session.getAttribute("userAuthority")),User.editNews)&&!((String)session.getAttribute("userName")).equals(creater)){
...
<div id="container">
    ...
    <div id="mainContent">
        ...
        <div id="rightMain">
            <div id="contentHeader">&nbsp;&nbsp;<a href="/jsp/manage/" class="normalLink">后台管理</a> &nbsp;&gt;&nbsp;<a href="/jsp/manage/newsManage/news.jsp?page=1" class="normalLink">新闻管理</a> &nbsp;&gt;&nbsp;修改新闻&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/Return.png" width="12" height="12" /><a
            ...
            <form name="form_article" method="post" style="margin:0 auto;margin-left:10px; margin-right:10px; text-align:left;">
                <div id="titleFrame">标题：
                  <input id="newsTitle" name="newsTitle" type="text" style="width:480px; height:16px;" value="<%=title%>"/>
              </div>
                <div class="modifyArticleFrame">发布者：<%=news.getCreater()%>&nbsp;&nbsp;&nbsp;发布于：<%=news.getCreateTime().substring(0, 16)%></div>
                <textarea id="newsContent" name="newsContent" style="width: 100%; height:310px;"><%=newsContent%></textarea>
            <div id="articleBottom">
                插入 本地图片/文件链接：
                <input type="file" name="articleFile" id="articleFile" size="20" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" name="saveFile" value="上传" onclick="return checkFileUpload('/jsp/manage/newsManage/saveNewsFile.jsp?isModify=1&id=<%=id %>&parent=<%=parentURL%>')" /> 
        	</div>
                <div id="articleBottom">
                    <input type="button" name="modify" value="确认修改" onclick="return checkArticle('/jsp/manage/newsManage/saveNews.jsp?isModify=1&id=<%=id %>&parent=<%=parentURL%>')" />
