...
<div id="container">
    ...
    <div id="mainContent">
        ...
        <div id="rightMain">
            <div id="contentHeader"><div style="float:left;">&nbsp;&nbsp;所有新闻：</div>
	...
	pageCtrl = newsBean.getPageWithContent(curPage, 8);
...
%>
			...
			while (pageCtrl.resultList.size() != 0) {
	        	SingleNews n = (SingleNews)pageCtrl.resultList.remove(0);
				String title = n.getTitle();
				String aTitle = title;
				String creater = n.getCreater();
	...
	%>
                <tr>
                    <td height="30px"></td>
                    <td height="30px" align="left" colspan="2" style="border-bottom: dashed 1px #AAA;"><img src="/images/news.png" width="12" height="12" /><a href="/jsp/manage/newsManage/showNews.jsp?id=<%=n.getId()%>&parent=<%=currentURL%>" class="itemName" title="<%=title%>"><%=aTitle%></a><%if(User.checkHaveAuthority(auth,User.editNews)||curUser.equals(creater)){ %>&nbsp;&nbsp;&nbsp;<img src="/images/Edit.png" width="12" height="12" /><a
                href="/jsp/manage/newsManage/editNews.jsp?id=<%=n.getId()%>&parent=<%=currentURL%>" target="_self" class="normalLink" >修改</a><%};if(User.checkHaveAuthority(auth,User.delNews)||curUser.equals(creater)){ %>&nbsp;&nbsp;&nbsp;<img src="/images/Delete.png" width="12" height="12" /><a
                href="/jsp/manage/newsManage/delNews.jsp?id=<%=n.getId()%>&parent=<%=currentURL%>" target="_self" class="normalLink" onclick="return onDelete()" >删除</a><%} %></td>
