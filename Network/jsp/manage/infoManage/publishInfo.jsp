...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <div id="rightMain" style="overflow:auto;">
      <div id="contentHeader">&nbsp;&nbsp;<a href="/jsp/manage/" class="normalLink">后台管理</a> &nbsp;&gt;&nbsp;<a href="/jsp/manage/infoManage/info.jsp?page=1" class="normalLink">通知管理</a> &nbsp;&gt;&nbsp;通知发布 </div>
      <form name="form_article" method="post" style="margin:0 auto;margin-left:10px; margin-right:10px;">
        <div id="titleFrame">标题：
          <input id="infoTitle" name="infoTitle" type="text" value="<%=title%>" style="width:480px; height:16px;"/>
        </div>
        <textarea id="infoContent" name="infoContent" style="width: 100%; height:330px;"><%=infoContent%>
                </textarea>
        <div id="articleBottom"> 插入 本地图片/文件链接：
          <input type="file" name="articleFile" id="articleFile" size="20" />
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="button" name="saveFile" value="上传" onclick="return checkFileUpload('/jsp/manage/infoManage/saveInfoFile.jsp?isModify=0')" />
        </div>
        <div id="articleBottom">
          <input type="button" name="publish" value="发布" onclick="return checkArticle('/jsp/manage/infoManage/saveInfo.jsp?isModify=0')" />
