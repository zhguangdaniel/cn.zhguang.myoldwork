...
<div class="container">
  ...
  <div id="main" class="content">
    ...
    <div id="leftFrame" class="leftContentFrame">
      <div class="myIndexLeftFrame">
        <jsp:include page="/jsp/myIndex/publishMsg.jsp" flush="true"></jsp:include>
      </div>
    </div>
    ...
    <div id="rightFrame" class="rightContentFrame">
      <div class="rightSubFrame">
        <jsp:include page="/jsp/user/userInfoFrame.jsp" flush="true"></jsp:include>
            ...
            <div class="rightSubFrame">
        <jsp:include page="/jsp/myIndex/menuFrame.jsp" flush="true"></jsp:include>
      </div>
      <div class="rightSubFrame">
